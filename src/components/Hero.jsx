      ...
      >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            A Full Stack Developer <br className="sm:block hidden" /> with a
            passion for building beautiful and scalable applications using MERN
            Stack.
          </p>
        </div>
      </div>
